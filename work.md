...
## 个人总结
  此数据库的简单设计有点类似与编程中的面向对象编程的类思想，表就是类，列就是属性（或者成员数据？）不同的学院、不同的班级、不同的人，不同的记录就是不同的对象或或者实例。就此设计，个人设计较为简单（仅仅使用了约束），本来是应该使用可视化工具，下了一个NAVICAT，可没学数据库基础也不知道怎么用，所以花了几个小时看了看数据库的基础（仅仅到约束）。事实上此数据库的建立也是在CMD中进行的，以下是我使用的命令以及数据库在终端的样子
    ...
    +------------+----------------+------------+----------------------+
    | student_id | name           | from_class | from_college         |
    +------------+----------------+------------+----------------------+
    | 1001       | 方此贤         |        101 | 传媒学院             |
    | 1002       | 言婴           |        101 | 传媒学院             |
    | 1003       | 玛托妮卡斯特罗 |        102 | 传媒学院             |
    | 1004       | 陈成           |        102 | 传媒学院             |
    | 1005       | 温幼菊         |        201 | 哲学学院             |
    | 1006       | 温幼兰         |        201 | 哲学学院             |
    | 1007       | 陈迎           |        202 | 哲学学院             |
    | 1008       | 可先           |        202 | 哲学学院             |
    | 1009       | 明石绫子       |        301 | 电气工程学院         |
    | 1010       | 纸月           |        301 | 电气工程学院         |
    | 1011       | 吾井昭太郎     |        302 | 电气工程学院         |
    | 1012       | 松下小津       |        302 | 电气工程学院         |
    | 1013       | 汉姆约翰逊     |        401 | 计算机科学与技术学院 |
    | 1014       | 张小明         |        401 | 计算机科学与技术学院 |
    | 1015       | 李明峰         |        402 | 计算机科学与技术学院 |
    | 1016       | 何其           |        402 | 计算机科学与技术学院 |
    +------------+----------------+------------+----------------------+
